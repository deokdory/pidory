...
**⚠️ 다중 사용자 지원은 아직 베타입니다.** 사용에 주의하세요.

이 모델은 길드에 초대된 사용자들이 서로 **신뢰 관계** 라는 가정 위에 작동합니다. pidory 를 실행 중인 서버에는 **진짜 믿을 수 있는 사람만 초대**하고 함께 작업하십시오. 그렇지 않으면 악의적인 사용자가 봇으로 임의 코드 실행 / 파일 조작 / 다른 사용자의 권한 승격을 할 수 있습니다.
